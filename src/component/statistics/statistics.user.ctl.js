;(function(){
    ...
    angular.module('app').config(['$stateProvider','$urlRouterProvider',
        function($stateProvider,$urlRouterProvider){
            $stateProvider.state({
                name: 'warpper.views.section.statisticsx_user',
                url: '^/statisticsx_user',
                templateUrl: './component/statistics/statistics.user.html'
           });

        }
    ])
    .controller('statisticsx_user',['$scope','$http','$timeout',
        function($scope,$http,$timeout){
        	var k=$scope;
        	k.uid=localStorage.statisticsuid;
        	console.log("k.uid:",k.uid);
        	k.xdtitle='';
			k.xdshow=false;
			k.show=function(e){
				k.xdtitle=e;
			...
			k.getList=function(){
				$http.get('/v1/aut/report/top',{
                    params:{
						uid:localStorage.statisticsuid
                    }
              }).then(function(res){
              			console.log(1111)
//                      k.list = res.data;
